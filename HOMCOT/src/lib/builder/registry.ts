/**
 * HOMCOT Visual Page Builder — Section Registry
 * 
...
export const sectionRegistry: SectionDefinition[] = [
  ...
  },
  {
    ...
    icon: "FileText",
    fields: [
      { key: "content", label: "HTML Content", type: "textarea", defaultValue: "<h2>HOMCOT - Buy Home Decor Items Online in India</h2><p>HOMCOT is built for people who want beautiful home decor without making shopping feel complicated...</p>" },
    ],
    defaultSettings: {
      content: "<h2>HOMCOT - Buy Home Decor Items Online in India</h2><p>HOMCOT is built for people who want beautiful home decor without making shopping feel complicated.</p><h2>Shop Home Decor by Category</h2><p>Every product card keeps price, discount, rating, wishlist and add-to-cart actions easy to scan on mobile and desktop.</p>",
    },
  },
