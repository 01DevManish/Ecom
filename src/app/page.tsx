...
export const metadata: Metadata = {
  ...
  description: "Buy home decor items online at myBEDZY. Shop bedding, wall decor, lighting, kitchen, dining, bath, garden, gifts and storage essentials.",
  alternates: {
    canonical: "/",
  },
};
...
export default async function HomePage() {
  ...
  const builderSchema = await getBuilderSchema("myBEDZY");
      ...
      <>
        ...
        <section className="qh-container qh-section-pad">
          <article className="qh-seo-copy max-w-none rounded-lg border border-border bg-background-elevated p-6 md:p-8">
            <h2>myBEDZY - Buy Home Decor Items Online in India</h2>
            <p>
              myBEDZY is built for people who want beautiful home decor without making shopping feel complicated.
    ...
    <>
      ...
      <section className="qh-container qh-section-pad">
        <article className="qh-seo-copy max-w-none rounded-lg border border-border bg-background-elevated p-6 md:p-8">
          ...
          <h2>Why myBEDZY Works Better for Everyday Shopping</h2>
          <p>
